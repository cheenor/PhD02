...
foldpath='X:\Data\Cloudsat\TP\CWC_RO\'
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
varnm={};
varnm{1,1}='RO_liq_effective_radius';
varnm{1,2}='RO_liq_number_conc';
varnm{1,3}='RO_liq_water_content';
varnm{2,1}='RO_ice_effective_radius';
varnm{2,2}='RO_ice_number_conc';
varnm{2,3}='RO_ice_effective_radius';
%%%%%%%  LO
varnm{1,4}='LO_RO_AP_geo_mean_radius';
varnm{1,5}='LO_RO_AP_number_conc';
varnm{1,6}='LO_RO_effective_radius';
varnm{1,7}='LO_RO_number_conc';
varnm{1,8}='LO_RO_liquid_water_content';
%%%%% IO
varnm{2,4}='IO_RO_AP_log_geo_mean_diameter';
varnm{2,5}='IO_RO_AP_log_number_conc';
varnm{2,6}='IO_RO_effective_radius';
varnm{2,7}='IO_RO_log_number_conc';
varnm{2,8}='IO_RO_ice_water_content';
...
fileOut='D:\MyPaper\PhD02\Data\EventsProfile_cloudsat_CWC_RO.txt';
